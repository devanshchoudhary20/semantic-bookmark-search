...
★ PRIVATE BY DESIGN
The only network request is a one-time download of the open-source embedding model. After that, everything is cached locally and works instantly — even offline.
